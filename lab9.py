...
def congratulation():
    ...
    if age < 18:
        message = f"Поздравляю тебя, {name}! Желаю тебе чудесных приключений и ярких моментов в жизни. Будь всегда {'' if gender == 'male' else 'всегда'}  дружелюбным{' и смелым' if gender == 'male' else ' и смелой'}, и, конечно же, наслаждайся каждым днем. Вот твой подарок — "
